      ...
      <div>
        <div className="mt-2 sm:mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 lg:gap-6">
          <Card className="overflow-hidden p-4 sm:p-6 flex flex-col items-start gap-2">
            <LoveIcon className="inline-flex size-7 sm:size-8 items-center justify-center rounded-sm bg-foreground/5 text-primary ring-1 ring-foreground/10 p-1 sm:p-1.5" />
          ...
          <Card className="group overflow-hidden p-4 sm:p-6 flex flex-col items-start gap-2">
            <FaceIcon className="inline-flex size-7 sm:size-8 items-center justify-center rounded-sm bg-foreground/5 text-primary ring-1 ring-foreground/10 p-1 sm:p-1.5" />
          ...
          <Card className="group overflow-hidden p-4 sm:p-6 flex flex-col items-start gap-2">
            <FoundedIcon className="inline-flex size-7 sm:size-8 items-center justify-center rounded-sm bg-foreground/5 text-primary ring-1 ring-foreground/10 p-1 sm:p-1.5" />
