...
import { SidebarIcon } from "@feedgot/ui/icons/sidebar"
...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@feedgot/ui/components/sheet"
...
function SidebarProvider({
  ...
  // Start with defaultOpen, then update from cookie after mount
  const [_open, _setOpen] = React.useState(defaultOpen)
  const [isInitialized, setIsInitialized] = React.useState(false)

  // Initialize from cookie after component mounts (client-side only)
  React.useEffect(() => {
