...
export const faqItems: FaqItem[] = [
  {
    ...
    answer:
      "You can start in minutes. Add the Feedgot widget, share a feedback link, or enable a public board—no complex setup required.",
  },
  {
    id: "item-2",
  ...
  {
    id: "item-4",
    question: "How does Feedgot help prioritize user feedback?",
    answer:
  ...
  {
    id: "item-5",
    question: "Can Feedgot help reduce customer churn?",
    answer:
  ...
  {
    id: "item-6",
    question: "Is Feedgot suitable for SaaS companies?",
    answer:
      "Absolutely. Product, support, and success teams use Feedgot to centralize feedback, align priorities, and communicate updates transparently.",
  },
  {
    id: "item-7",
    question: "Can I use Feedgot as a product roadmap tool?",
    answer:
  ...
  {
    id: "item-10",
    question: "How can Feedgot improve customer experience management?",
    answer:
  ...
  {
    id: "item-13",
    question: "What integrations does Feedgot offer?",
    answer:
