    ...
    <div aria-hidden className="relative">
      <Card className="aspect-video w-4/5 translate-y-2 p-3">
        <div className="mb-3 grid grid-cols-[auto_1fr] gap-2">
          <div className="bg-background size-6 rounded-sm border p-0.5 shadow shadow-zinc-950/5">
            <img
        ...
        <div className="ml-8 space-y-2">
          <div className="bg-foreground/10 h-2 rounded-sm"></div>
          <div className="bg-foreground/10 h-2 w-3/5 rounded-sm"></div>
          <div className="bg-foreground/10 h-2 w-1/2 rounded-sm"></div>
        </div>
      ...
      <Card className="aspect-3/5 absolute right-0 top-4 flex w-2/5 translate-y-4 p-2 transition-transform duration-200 ease-in-out group-hover:rotate-3">
        <div className="bg-foreground/5 m-auto flex size-10 rounded-sm">
