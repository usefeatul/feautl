          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            <div className="group relative rounded-sm border border-foreground/10 bg-white p-5 sm:p-6 transition-shadow hover:shadow-sm">
              <div className="flex items-start gap-3">
                <span className="inline-flex size-7 sm:size-8 items-center justify-center rounded-sm bg-foreground/5 text-primary ring-1 ring-foreground/10 p-1 sm:p-1.5">
