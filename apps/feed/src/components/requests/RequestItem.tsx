...
function RequestItemBase({ item, workspaceSlug }: { item: RequestItemData; workspaceSlug: string }) {
  ...
  return (
    <li className="rounded-sm border bg-card p-2.5">
      <div className="flex items-center gap-3">
        ...
        <div className="ml-auto flex items-center gap-3 text-xs text-accent">
          <div className="inline-flex items-center gap-2 bg-muted rounded-sm ring-1 ring-border px-2 py-1">
          ...
          <Avatar className="size-6 bg-muted ring-1 ring-border rounded-sm">
