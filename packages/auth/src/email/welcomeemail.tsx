...
export function WelcomeEmail({ name, brand }: { name?: string; brand?: Brand }) {
  ...
  const title = brand?.name ? `Welcome to ${brand.name}` : "Welcome to featul"
