...
export default async function PublicBoardRequestDetailPage({ params }: Props) {
  ...
  return <SubdomainRequestDetail post={{ ...p, hasVoted } as any} workspaceSlug={subdomain} initialComments={initialComments as any} initialCollapsedIds={initialCollapsedIds} backLink={`/board/${p.boardSlug}`} />
}
